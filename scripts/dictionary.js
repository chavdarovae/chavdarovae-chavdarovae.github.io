            ...
            <div class="main__about-skills  column column--centered">
                <div class="main__about-skills-entry skill-set">
                    ...
                    <ul class="skill-set__list">
                        ...
                        <li class="skill-set__list-item">Cyress</li>
                    </ul>
                </div>
...
<body>
    ...
    <main class="main">
        ...
        <section class="main__experience hidden" id="experienceSection">
            <div class="content-container">
                ...
                <article class="work">
                    ...
                    <h4 class="work__employer">Carrypicker GmbH – Hamburg, Germany</h4>
                    ...
                    <div class="work__description">
                        ...
                        <p>
                            For further information see <a href="#" class="work__description-link" id="projects">Projects</a> section.
                        </p>
                    </div>
                </article>
        ...
        <section class="main__projects hidden" id="projectsSection">
            ...
            <div class="anchor-nav">
                <ul class="anchor-nav__list">
                    <li class="anchor-nav__list-item"><a href="#" class="anchor-nav__list-link anchor-nav__list-link--current" id="workProjects">Work</a></li>
                    <li class="anchor-nav__list-item"><a href="#" class="anchor-nav__list-link" id="personalProjects">Personal</a></li>
                    <li class="anchor-nav__list-item"><a href="#" class="anchor-nav__list-link" id="studyProjects">Study</a></li>
                </ul>
            </div>
            <div class="content-container" id="workProjectsDiv">
                ...
                <div class="project">
                    ...
                    <p class="project__highlights">
                        Developed further features for three web applications: Carrypicker, Colleta TMS and Colleta Trucking. The symbiotic relationship between them allows for them to cover all three steps of the truck transport logistics process. Starting with placing a shipment order in Carrypicker, going through an AI based automatic disposition with a fallback option - manual disposition in Colleta TMS.  And ending with issuing tour request and transportation orders via Colleta Trucking Platform, while having Colleta User Management Platform as the middle man in this ecosystem.
                    </p>
                    <p class="project__info">
                    ...
                    <div class="project__media project__media--info">
                        ...
                        <div class="project__media-info">
                            <p>Carrypicker is a web platform, where shippers can easily input shipping orders. It provides AI-based day price calculation algorithm and supports manual, CSV or excel based shipment input.</p>
                            <p>The web portal keeps track of the status and the position of the shipments relevant to a single user or to a group of users. It also issues automatically shipping orders and allows for document exchange between stakeholders.</p>
                            <a href="https://my.carrypicker.com/">https://my.carrypicker.com/</a>
                        </div>
                        <!-- <div class="project__media-img">
                            <img src="./assets/images/Carrypicker-ui/1.png" alt="Shipment orders list view">
                    ...
                    <div class="project__media project__media--info">
                        ...
                        <div class="project__media-info">
                            <p>Colleta TMS is a disposition tool that serves mainly transport management purposes. It is meant as a fallback web platform, where shipments that could not be disposed automatically by the AI, are bundled manually by dispatchers. </p>
                            <p>Colleta TMS reduces the process chain of bundling multiple shipments together, creating a tour request and contacting numerous carriers to a couple of button clicks. The price negotiation and the actual assignment of a transport order also take place in this web platform.</p>
                            <a href="https://neu.colleta.de/">https://neu.colleta.de/</a>
                        </div>
                        <!-- <div class="project__media-img">
                            <img src="./assets/images/Colleta-tms/1.png" alt="Login-first step view">
                    ...
                    <div class="project__media project__media--info">
                        ...
                        <div class="project__media-info">
                            <p>Colleta Trucking is a web application meant for transportation carriers. It allows them to actively participate in tour request bids, register available transportation vehicles and commonly run routes. Another feature of the platform is keeping history of all transportation assignments and providing online-access the respective documentation.</p>
                            <a href="https://trucking.colleta.de/">https://trucking.colleta.de/</a>
                        </div>
                        <!-- <div class="project__media-img">
                            <img src="./assets/images/Colleta-trucking/1.png" alt="Login-first step view">
                    ...
                    <div class="project__media project__media--info">
                        ...
                        <div class="project__media-info">
                            <p>Colleta Manager does the user management for the other three web platforms: Carrypicker, Colleta and Colleta Trucking. It allows for intersystem data exchange and is the place where the onboarding for all stakeholders in the Carrypicker ecosystem takes place.</p>
                            <a href="https://my.colleta.de/">https://my.colleta.de/</a>
                        </div>
                        <!-- <div class="project__media-img">
                            <img src="./assets/images/Colleta-manager/1.png" alt="Login-first step view">
