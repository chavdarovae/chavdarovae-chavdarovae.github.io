...
<section class="main__about" id="aboutSection">
    <div class="content-container">
        ...
        <div class="main__about-journey column column--centered">
            ...
            <p class="main__about-journey-item">
                In den letzten 4 Jahren habe ich mich entschieden, dieses Streben voll und ganz zu verfolgen, indem ich ein Entwicklerprogramm in SoftUni Software-Akademie aufnahm und meine erste Webanwendung komplett von Grund auf neu entwickelte. Gespannt darauf, diese aufregende Reise fortzusetzen und meine Fähigkeiten beruflich weiterzuentwickeln.Ich habe mich einem Team von gleichgesinnten Entwicklern angeschlossen, die meine Leidenschaft für das Erforschen, Lernen und Erstellen von Anwendungen teilen, die unsere Lebensqualität verbessern.
            </p>
        </div>
